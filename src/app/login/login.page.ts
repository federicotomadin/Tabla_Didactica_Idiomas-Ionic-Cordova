...
export class LoginPage implements OnInit {
  ...
  constructor(public afAuth: AngularFireAuth, private authService: AuthService, public navCtrl: NavController, 
              public router: Router, public alertController: AlertController, private servicio: AuthService, 
              public formBuider: FormBuilder, private splashScreen: SplashScreen) {
